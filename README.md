...
| Feature | Algorithm / Data Structure Used |
|---|---|
| Spell-corrected item search ("Did you mean...?") | Trie + Levenshtein Edit Distance (Dynamic Programming) |
| Autocomplete while typing | Trie prefix traversal |
| Keyword / substring search | Rabin-Karp rolling hash |
| Category-wise browsing | HashMap grouping |
| Price-range search | Binary Search (on a price-sorted list) |
| Top-N cheapest / most expensive items | PriorityQueue (Heap) |
| Shopping cart with running total | HashMap |
| Trending searches | HashMap frequency counter |
| Catalog structure visualization | Trie traversal / printing |
